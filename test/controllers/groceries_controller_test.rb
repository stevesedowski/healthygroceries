...
class GroceriesControllerTest < ActionController::TestCase
  ...
  test "should create grocery" do
    assert_difference('Grocery.count') do
      post :create, grocery: { bought: @grocery.bought, healthy: @grocery.healthy, item: @grocery.item, price: @grocery.price }
    end
  ...
  test "should update grocery" do
    patch :update, id: @grocery, grocery: { bought: @grocery.bought, healthy: @grocery.healthy, item: @grocery.item, price: @grocery.price }
    assert_redirected_to grocery_path(assigns(:grocery))
  end
